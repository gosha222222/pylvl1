# Со словарем работать вообще не пришлось - намного проще было с массивами
# Решил, что для вывода в случае дальнейшей работы будет удобнее создать
# новый файл с теми, у кого зп меньше 500000. Было непросто :)
# Наверное, сделано нелогично и коряво, но оно работает
